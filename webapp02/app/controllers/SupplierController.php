...
class SupplierController {
    ...
    public function remove($id) 
    {
        ...
        if ($result) {
            echo "<script>alert('¡El suplidor se eliminó correctamente!');</script>"; // Redirigir o mostrar un mensaje de éxito
        } else {
            echo "<script>alert('¡Error al eliminar el suplidor!');</script>"; //// Mostrar un mensaje de error
        }
        $data['view'] = 'app/views/supplier/list.php';
        $data['suppliers'] = $this->supplierModel->getAll();
        include 'app/views/home.php';
