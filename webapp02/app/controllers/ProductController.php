...
class ProductController {
    ...
    public function remove($id) 
    {
        ...
        if ($result) {
            echo "<script>alert('¡El producto se eliminó correctamente!');</script>"; // Redirigir o mostrar un mensaje de éxito
        } else {
            echo "<script>alert('¡Error al eliminar el producto!');</script>"; //// Mostrar un mensaje de error
        }
