...
class UserController {
    ...
    public function remove($id) 
    {
        ...
        if ($result) {
            echo "<script>alert('¡El usuario se eliminó correctamente!');</script>"; // Redirigir o mostrar un mensaje de éxito
        } else {
            echo "<script>alert('¡Error al eliminar el usuario!');</script>"; // Mostrar un mensaje de error
        }
        $data['view'] = 'app/views/user/list.php';
        $data['users'] = $this->userModel->getAll();
        include 'app/views/home.php';
