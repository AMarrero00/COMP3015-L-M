const API_KEY = "8c3c1dccb9695938d51be8321771d1c6"; // Reemplaza esto con tu API key
        ...
        $("#checkWeather").click(function () {
            ...
            success: function (data) {
                ...
                data.list.forEach((day) => {
                        forecastHtml += `<strong>Fecha:</strong> ${new Date(day.dt*1000).toDateString()} ${new Date(day.dt * 1000).toTimeString()}<br>
